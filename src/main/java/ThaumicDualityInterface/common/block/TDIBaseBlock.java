...
public abstract class TDIBaseBlock extends AEBaseTileBlock implements IRegister<TDIBaseBlock> {

    public TDIBaseBlock(Material mat, String name) {
        super(mat);
        this.setBlockName(name);
        this.setBlockTextureName(ThaumicDualityInterface.MODID + ":" + name);
    }
